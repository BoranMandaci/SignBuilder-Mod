...
*   🔧 **Neon Mekanikleri ve Kızıltaş** — İngiliz Anahtarı (Wrench) ile herhangi bir karaktere sağ tıklayarak iç aydınlatmasını açıp kapatın. Tabelalarınızı kızıltaş sinyallerine bağlayarak parlayan neon efektlerini otomatikleştirin!
*   🌍 **Küresel Dil Desteği** — İngilizce, Türkçe, Rusça, İspanyolca, Basitleştirilmiş Çince, Almanca, Fransızca ve İtalyanca dillerine tamamen çevrilmiş ve desteklenmiştir.

## 🛠️ Teknoloji Yığını

**Modlama API'si ve Diller**
*   ☕ **Java** — Temel mantık ve arka uç geliştirme.
*   🧩 **Architectury API** — Forge ve Fabric platformlarında aynı anda geliştirme yapmayı sağlayan çapraz platform katmanı.
*   🦊 **Fabric** / 🔨 **Forge** — Mod yükleyicileri.

**Araçlar**
*   🧊 **Blockbench** — Tüm karakter ve araç blokları için özel 3D modelleme ve doku tasarımı.
...
### Adımlar
1.  Modun en güncel sürümünü **[CurseForge](https://www.curseforge.com/minecraft/mc-mods/sign-builder)** veya **[Modrinth](https://modrinth.com/mod/sign-builder)** üzerinden indirin.
2.  Gerekli sürümdeki Architectury API'sini indirin.
3.  Her iki `.jar` dosyasını da Minecraft'ın içindeki `mods` klasörüne atın.
4.  Oyunu başlatın!
